...
export const applyImagePlaceholders = (imgElement: HTMLImageElement): void => {
  ...
  if (!imgElement.classList.contains('loaded')) {
    ...
    // Remove blur when actual image loads
    imgElement.addEventListener('load', function() {
      if (this.src !== LQIP_MAP[targetSrc] && this.src !== 'data:image/svg+xml,%3Csvg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 4 3"%3E%3C/svg%3E') {
